...
struct CardsStackView<Model>: View
where Model: TextImageProviding & Hashable
{
    ...
    var body: some View {
        ...
        GeometryReader { proxy in
            ...
            ZStack {
                ...
                ForEach(Array(models.enumerated()), id: \.element) { index, item in
                    
                    if (models.count - 3)...models.count ~= index {
                        
                        CardView(model: item) { model, isLiked in
